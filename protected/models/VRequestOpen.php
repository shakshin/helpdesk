...
/**
 * This is the model class for table "v_request_open".
 *
 * The followings are the available columns in table 'v_request_open':
 * @property string $id
 ...
 * @property string $wcount
 */
class VRequestOpen extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return VRequestOpen the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('closed, uuser, rtype_id, group_full, group_work, group_view, worker_id', 'length', 'max'=>10),
			array('wcount', 'length', 'max'=>21),
			array('regtime, description, utime, date_plan, date_end', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, regtime, department, position, fio, phone, pc, ip, description, closed, utime, uuser, rtype, rtype_id, group_full, group_work, group_view, worker_id, date_plan, date_end, deadline, wcount', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('wcount',$this->wcount,true);
