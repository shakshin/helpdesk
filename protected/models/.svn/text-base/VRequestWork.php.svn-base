...
/**
 * This is the model class for table "v_request_work".
 *
 * The followings are the available columns in table 'v_request_work':
 * @property string $id
 ...
 */
class VRequestWork extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return VRequestWork the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('department, fio, phone, ip, uuser, worker_id', 'required'),
			...
			array('id, regtime, department, position, fio, phone, pc, ip, description, closed, utime, uuser, rtype, rtype_id, group_full, group_work, group_view, worker_id, date_plan, date_end, deadline', 'safe', 'on'=>'search'),
		);
	}
